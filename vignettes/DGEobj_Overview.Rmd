...
This function is intended to return any project oriented attributes assigned to
the DGEobj using function `annotateDGEobj`.  It returns the attributes as a
two column dataframe of Attribute/Value pairs.  
